    ...
    GatewayPorterAbstract
{
     ...
     * @throws \Exception
     */
    public function newZendeskUpsertUserRequestController(
        ?string $user_id,
        ...
        $request_data = new ZendeskUpsertUserRequestData(
            'create_or_update',
            $user_id,
            $email_address,
            $name,
        ...
        return new ZendeskUpsertUserRequestController(
