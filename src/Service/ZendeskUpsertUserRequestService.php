<?php
    ...
    */
   class ZendeskUpsertUserRequestService implements RequestServiceInterface
   {
                                              ...
                                              array $metadata ): object
      {
         ...
         return new ZendeskUpsertUserResponseData( $api_response,
                                                   $gateway_name,
                                                   $action );
      }
       ...
       * @return array
       */
      private function translateZendeskUpsertUserRequest ( ZendeskUpsertUserRequestData $request_data ): array
      {
