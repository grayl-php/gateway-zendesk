<?php
    ...
    */
   class ZendeskUpsertUserRequestControllerTest extends TestCase
   {
      ...
      public function testCreateZendeskGatewayData (): ZendeskGatewayData
      {
         ...
         $this->assertInstanceOf( ZendeskGatewayData::class,
                                  $gateway );
       ...
       * @throws \Exception
       */
      public function testCreateZendeskUpsertUserRequestController (): ZendeskUpsertUserRequestController
      {
         ...
         $request = ZendeskPorter::getInstance()
                                 ->newZendeskUpsertUserRequestController( null,
                                                                          $tag . '@test.com',
         ...
         // Check the type of object returned
         $this->assertInstanceOf( ZendeskUpsertUserRequestController::class,
                                  $request );
       ...
       * @throws \Exception
       */
      public function testSendZendeskUpsertUserRequestController ( ZendeskUpsertUserRequestController $request )
      {
         ...
         // Check the type of object returned
         $this->assertInstanceOf( ZendeskUpsertUserResponseController::class,
                                  $response );
       ...
       */
      public function testZendeskResponseController ( ZendeskUpsertUserResponseController $response ): void
      {
